...
export const whatsappSettingsTable = pgTable("whatsapp_settings", {
  ...
  notifyOrderFailedDelivery: boolean("notify_order_failed_delivery").notNull().default(true),
  notifyOrderReturn: boolean("notify_order_return").notNull().default(true),
  notifyOrderRefund: boolean("notify_order_refund").notNull().default(true),
  notifyReviewRequest: boolean("notify_review_request").notNull().default(true),
  reviewCouponCode: text("review_coupon_code"),
