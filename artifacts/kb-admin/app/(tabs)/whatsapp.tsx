...
const styles = StyleSheet.create({
  ...
  refreshBtn: { padding: 9, backgroundColor: `${GOLD}18`, borderRadius: 12, borderWidth: 1, borderColor: `${GOLD}30` },
  statsRow:   { flexDirection: "row", gap: 10, paddingHorizontal: 16, paddingVertical: 12 },
  statPill:   { flex: 1, flexDirection: "row", alignItems: "center", gap: 6, padding: 10, borderRadius: 14, borderWidth: 1 },
  statVal:    { fontSize: 16, fontFamily: "Inter_700Bold" },
  statLabel:  { color: "rgba(255,255,255,0.4)", fontSize: 11, fontFamily: "Inter_400Regular" },
  convCard:   { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: CARD, borderRadius: 16, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: BORDER },
  ...
  unreadBadge:{ backgroundColor: WGREEN, borderRadius: 10, minWidth: 20, height: 20, alignItems: "center", justifyContent: "center", paddingHorizontal: 4 },
