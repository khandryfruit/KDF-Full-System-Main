...
function MenuItem({ icon, label, value, color = "rgba(255,255,255,0.7)", onPress, danger }: {
  icon: string; label: string; value?: string; color?: string; onPress?: () => void; danger?: boolean;
}) {
  return (
  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          <MenuItem icon="sliders" label="Module Controls" onPress={() => router.push("/(tabs)/modules" as any)} color={GOLD} />
...
const styles = StyleSheet.create({
  ...
  rolePill:    { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 12, paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20, borderWidth: 1 },
  ...
  menuItem:    { flexDirection: "row", alignItems: "center", gap: 12, padding: 14, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.04)" },
