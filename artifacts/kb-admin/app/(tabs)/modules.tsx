  ...
  return (
    <View style={[styles.card, !module.is_enabled && styles.cardDisabled]}>
      ...
      <Switch
        ...
        onValueChange={val => { Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); onToggle(module.module_key, val); }}
...
const styles = StyleSheet.create({
  ...
  banner:     { flexDirection: "row", alignItems: "center", gap: 8, marginHorizontal: 16, marginVertical: 10, backgroundColor: `${GOLD}10`, borderRadius: 12, padding: 12, borderWidth: 1, borderColor: `${GOLD}20` },
  bannerTxt:  { color: "rgba(255,255,255,0.55)", fontSize: 12, fontFamily: "Inter_400Regular", flex: 1 },
  card:       { flexDirection: "row", alignItems: "center", gap: 14, backgroundColor: CARD, borderRadius: 18, padding: 16, marginBottom: 10, borderWidth: 1, borderColor: BORDER },
  ...
  visBadge:   { flexDirection: "row", alignItems: "center", gap: 3, backgroundColor: `${GOLD}10`, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 8, borderWidth: 1, borderColor: `${GOLD}20` },
