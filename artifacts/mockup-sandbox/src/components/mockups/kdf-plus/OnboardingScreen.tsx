...
export function OnboardingScreen() {
  const [activeSlide, setActiveSlide] = useState(1); // 0-indexed, so slide 2 is 1
  ...
  return (
    <div className="w-full h-screen min-h-[100dvh] bg-[#F8F9FB] flex flex-col relative overflow-hidden font-sans">
