...
export function OTPScreen() {
  ...
  if (isSuccess) {
    return (
      <div className="w-full min-h-[100dvh] bg-[#F8F9FB] flex flex-col font-sans relative overflow-hidden items-center justify-center">
  ...
  return (
    <div className="w-full min-h-[100dvh] bg-[#F8F9FB] flex flex-col font-sans relative overflow-hidden">
      {/* Header */}
      <div className="flex items-center h-16 px-4 shrink-0 bg-white shadow-sm z-10 relative">
        <button className="p-2 -ml-2 text-gray-800 hover:bg-gray-100 rounded-full transition-colors active:scale-95">
      ...
      {/* Bottom Sticky Area */}
      <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 p-4 pb-6 flex flex-col items-center gap-3 z-30 shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)]">
        <button
