        ...
        {items.map((p) => {
          ...
          return (
            <button
              ...
              type="button"
              onClick={() => onSelect(p)}
              className="group flex min-w-[108px] max-w-[120px] shrink-0 flex-col overflow-hidden rounded-2xl border border-gray-100/95 bg-white/90 text-left shadow-sm ring-1 ring-black/[0.04] backdrop-blur-sm transition-[transform,box-shadow,border-color] duration-300 hover:-translate-y-0.5 hover:border-[#5FA800]/35 hover:shadow-lg motion-reduce:transition-none motion-reduce:hover:translate-y-0"
            >
