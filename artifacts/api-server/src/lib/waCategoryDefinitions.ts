...
export const WA_SALES_CATEGORIES: WaSalesCategory[] = [
  ...
  { id: "cashew", emoji: "🌰", labelEn: "Cashew / Kaju", labelUr: "کاجو / Cashew", families: ["kaju", "cashew", "cashews", "کاجو", "w180", "w240", "w320"] },
  {
    ...
    emoji: "🌰",
    labelEn: "Walnuts",
    labelUr: "Walnuts / اخروٹ",
    families: ["akhrot", "walnut", "walnuts", "اخروٹ", "walnut giri", "akhrot giri"],
  },
  ...
  { id: "berries", emoji: "🍇", labelEn: "Dried Berry", labelUr: "Dried Berry", families: ["berry", "berries", "dried berry", "goji", "cranberry", "blueberry", "strawberry"] },
  { id: "raisins", emoji: "🍇", labelEn: "Raisins / Kishmish", labelUr: "کشمش", families: ["kishmish", "raisin", "raisins", "munakka", "کشمش"] },
  { id: "figs", emoji: "🫐", labelEn: "Dried Figs", labelUr: "Dried Figs / انجیر", families: ["anjeer", "fig", "figs", "dried fig", "dried figs", "انجیر"] },
  {
    id: "dried_fruits",
    emoji: "🥭",
    labelEn: "Dried Fruits",
    labelUr: "Dried Fruits",
    families: [
      "dried fruit", "dried fruits", "kiwi", "pineapple", "papaya", "mango slice",
      "fruit slice", "tropical", "cantaloupe", "honeydew", "mixed fruit",
    ],
  },
