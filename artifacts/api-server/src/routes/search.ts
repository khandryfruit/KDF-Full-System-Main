...
const SYNONYMS: Record<string, string[]> = {
  // Roman Urdu → English (badam, pista, akhrot, kaju …)
  badam: ["almond"], badaam: ["almond"], baadam: ["almond"],
  pista: ["pistachio"], pistay: ["pistachio"], pisteh: ["pistachio"],
  akhrot: ["walnut"], akhroot: ["walnut"], akhroat: ["walnut"],
  kaju: ["cashew"], kajoo: ["cashew"], kaaju: ["cashew"],
  kishmish: ["raisin"], kishmash: ["raisin"], kismis: ["raisin"],
  khajoor: ["date"], khajur: ["date"], khajura: ["date"],
  anjeer: ["fig"], anjir: ["fig"], angeer: ["fig"],
  chilgoza: ["pine nut"], chilghoza: ["pine nut"], chilgoze: ["pine nut"],
  mungfali: ["peanut"], mungphali: ["peanut"],
  moongfali: ["peanut"], moongphali: ["peanut"],
  khumani: ["apricot"], khubani: ["apricot"], khobani: ["apricot"],
  meva: ["dry fruit"], mewa: ["dry fruit"], maywa: ["dry fruit"],
  "khushk mewa": ["dry fruit"], "khushk meva": ["dry fruit"],
  angoor: ["raisin"],
  rewari: ["rewari"], rewri: ["rewari"],
  "pine nuts": ["pine nut"], "pine nut": ["pine nut"],
  // Urdu script → English
  "اخروٹ": ["walnut"], "اخروٹ گری": ["walnut"],
  "بادام": ["almond"], "بادام گری": ["almond"],
  "کاجو": ["cashew"],
  "پستہ": ["pistachio"],
  "کشمش": ["raisin"],
  "خشک میوہ": ["dry fruit"], "میوہ": ["dry fruit"], "مغز": ["nut"],
  "انجیر": ["fig"],
  "کھجور": ["date"],
  "مونگ پھلی": ["peanut"], "مونگ‌پھلی": ["peanut"],
  "چلغوزہ": ["pine nut"],
  "خوبانی": ["apricot"],
  // Arabic
  "لوز": ["almond"], "جوز": ["walnut"],
  // Plurals / common misspellings
  almonz: ["almond"], almonds: ["almond"],
  cashews: ["cashew"],
  pistachios: ["pistachio"],
  walnuts: ["walnut"],
  raisins: ["raisin"],
  peanuts: ["peanut"],
  hazelnuts: ["hazelnut"], hasel: ["hazelnut"], hazel: ["hazelnut"],
  "dry fruits": ["dry fruit"], "dried fruit": ["dry fruit"],
  nuts: ["nut"],
  // Mixed language / sentence fragments → key product
  "mujhe badam": ["almond"], "badam chahiye": ["almond"],
  "pista chahiye": ["pistachio"], "akhrot chahiye": ["walnut"],
  "kaju chahiye": ["cashew"],
};
